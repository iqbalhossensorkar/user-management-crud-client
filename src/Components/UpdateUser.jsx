        ...
        <>
            ...
            <div className="p-10 bg-slate-100 mx-10 rounded mb-10">
                <div className="text-center">
                    <h2 className="text-xl font-bold my-5">Update User</h2>
                ...
                <form onSubmit={handleUpdateUser}>
                    ...
                    <div className="form-control w-full">
                        ...
                        <input type="email" defaultValue={email} name="email" className="input input-bordered w-full" required />
                    </div>
                    {/* Gender Radio */}
                    ...
                    <input className="btn btn-success w-full mt-8" type="submit" value="Update User" />
                </form>
            </div>
        </>
    );
